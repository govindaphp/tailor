      ...
      <div class="container-fluid page-body-wrapper full-page-wrapper">
        <div class="content-wrapper d-flex align-items-center auth px-0">
          <div class="row w-100 mx-0">
            ...
            <div><a href="{{ url('login') }}" class="btn btn-outline-primary btn-lg btn-block" style="width: 49%;">Customer</a>
            <a href="{{ route('vendorLoginForm') }}" class="btn btn-block btn-primary btn-lg btn-block"  style="width: 49%;">Vendor</a></div>
              <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                ...
                <form class="pt-3" method="POST" action="{{ route('vendorLoginForm') }}">
                {!! csrf_field() !!}
                  ...
                  <div class="mt-3 d-grid gap-2">
                  <a href="{{ route('google.redirectvend') }}" class="btn btn-block btn-google auth-form-btn">
                  ...
                  <div class="text-center mt-4 font-weight-light"> Don't have an account? <a href="{{ route('vendorSignupForm') }}" class="text-primary">Create</a>
                  </div>
                </form>
              </div>
            </div>
