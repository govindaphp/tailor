...
@foreach ($chats as $chat)
    @if ($chat->sender_id != $merchent->vendor_id)
    ...
    @else
        ...
        <div class="chat-message d-flex justify-content-end mb-3">
          ...
          <div class="message-avatar ms-3">
            <img src="{{$merchent->profile_img==''? url('/public').'/front_assets/images/reviw1.png' : url('/public').'/admin/uploads/user/'.$merchent->profile_img}}" alt="Receiver Avatar" class="rounded-circle">
