...
<div class="col-md-3 p-0">
  ...
  <div class="sidebar chat--box">
    ...
    <ul class="people">
      ...
      <span style="width: 35px;" class="name">{{$user->first_name}}</span>
  ...
  <div class="col-md-9">
    ...
    <div class="conversation-start">
      ...
      <div class="chat-footer d-flex align-items-center p-3 bg-white">
        <input type="hidden" name="auth_id" id="auth_id" value="{{auth('vendor')->id()? auth('vendor')->id() :'0'}}">
...
<script>
  function myFunction() {
    ...
    $.ajax({
        url: "{{url('/merchentMessageSubmit')}}", // Replace with your backend route
        type: 'POST', 
