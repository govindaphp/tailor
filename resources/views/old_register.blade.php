      ...
      <div class="container-fluid page-body-wrapper full-page-wrapper">
        <div class="content-wrapper d-flex align-items-center auth px-0">
          <div class="row w-100 mx-0">
            ...
            <div><a href="{{ url('register') }}" class="btn btn-block btn-primary btn-lg btn-block" style="width: 49%;">Customer</a>
            <a href="{{ route('vendorSignupForm') }}" class="btn btn-outline-primary btn-lg btn-block"  style="width: 49%;">Vendor</a></div>
