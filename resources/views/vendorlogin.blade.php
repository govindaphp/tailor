            ...
            <div class="container">
                <div class="row elite-register-inner">
                    <div class="signup-login-btn">
                        <a href="{{ url('login') }}" class="btn btn-outline-primary btn-lg btn-block vendor" style="width: 49%;">Customer</a>
                        <a href="{{ route('vendorLoginForm') }}" class="btn btn-block btn-primary btn-lg btn-block customer" style="width: 49%;">Vendor</a>
                    </div>
                    ...
                    <div class="signup-inner-content">
                        ...
                        <div class="form-register form-login">
                            ...
                            <form class="pt-3" action="{{ route('vendorLoginForm') }}" method="POST">
                            {!! csrf_field() !!}
                                ...
                                <p class="already-account">Don't have an account yet? <a href="{{ url('vendorSignup') }}">Sign Up</a></p>
                                ...
                                <div class="three-btn">
                                    ...
                                    <a href="{{ route('google.redirectvend') }}"><img class="three" src="https://votivelaravel.in/tailor_hub/public/web/images/three.svg" /></a>
