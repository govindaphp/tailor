    ...
    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
      <div class="menu_section">
        <ul class="nav side-menu">
          <li>
            <a class="dropdown-toggle" href="{{route('admindashboard')}}"><i class="fa fa-home" ></i> Dashboard </a>
          </li>
          <li>
            <a class="dropdown-toggle"><i class="fa fa-user" aria-hidden="true"></i>
            ...
            <ul class="nav child_menu" style="display: none;">
              ...
              <li><a href="">ViP Customer Management</a></li>
            </ul>
          </li>

          <li><a><i class="fa fa-edit"></i> Vendor <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="form.html">Tailor Management</a></li>
