...
@section('title','VIP Edit Customer')
    ...
    <div class="">
        ...
        <div class="row">
            ...
            <div class="col-md-12 customer-form-first">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>VIP Customer Edit </h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <br />
                        <form action="{{ route('admin.vipcustomerFormAction') }}" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left" id="course_form">
                            {!! csrf_field() !!}
