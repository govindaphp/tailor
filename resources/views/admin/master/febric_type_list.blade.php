...
@section('title','Febric Type List')
      ...
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          <div class="x_title d-flex justify-content-between align-items-center">
            <h2 class="mb-0">Febric Type List</h2>
            <a href="{{route('addFebricType')}}" class="btn btn-primary">Add New</a>
          </div>
          <div class="x_content">
            <div class="row">
              <div class="col-sm-12">
                <div class="card-box table-responsive">
                  <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                    ...
                    <tbody>
                      ...
                      <?php $i = 1; ?>
                      @foreach ($febric_type_list as $list)
                      <tr>
                        <td>{{$i}}</td>
...
<script>
    $('.toggle-class').on("change", function() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo url('/admin/changeFebricTypeStatus'); ?>",
            data: {
                _token: '{{ csrf_token() }}',
                'status': status,
                'id': id
