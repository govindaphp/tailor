        ...
        <div class="row">
            ...
            <div class="col-md-12 customer-form-first">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="{{ url('admin/termsConditions') }}" id="course_form" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
                            {!! csrf_field() !!}
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label class="control-label">Terms & Conditions<span class="mandatory" style="color:red"> *</span></label>
                                    <textarea name="policy_content">  {{ $terms?$terms->policy_content:'' }}</textarea>
...
window.addEventListener('load', function() {
    $("#course_form").validate({
        rules: {
            ...
            messages: {
                policy_content: { required: "Policy Content is required" }
