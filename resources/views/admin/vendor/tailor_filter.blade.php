                ...
                <div class="card-box table-responsive">
                  <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                    ...
                    <select id="heard12" class="form-control" required>
                        ...
                        <td>
                          <a href="{{ route('admin.vip_customer_view',$list->vendor_id)}}" class="btn btn-sm btn-info"><i class="fa fa-eye"></i></a>
                          <a href="{{ route('admin.vip_customer_edit',$list->vendor_id)}}" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                          <a title="Delete User" class="btn btn-sm btn-danger" href="{{ route('admin.delete_user_list',$list->vendor_id)}}" onclick="return confirm('Are you sure you want to delete this record?')"><i class="fa fa-trash"></i>
                        </td>
                      </tr>
                      <?php $i++; ?>
                      @endforeach
...
<!-- <script>
  ...
  $('#applyFilter').click(function() {
    ...
    $.ajax({
      url: '{{ url('/vendor-filter')}}', // Replace with your server endpoint
      type: 'POST',
      data: filterData,
