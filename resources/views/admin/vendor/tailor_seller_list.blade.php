...
<form  id="">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-3">
            <label class="control-label">Fabric Seller Type<span class="mandatory" style="color:red"> *</span></label>
      ...
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          <div class="x_title d-flex justify-content-between align-items-center">
            <h2 class="mb-0">Tailor $ Fabric Seller List</h2>
            <a href="{{route('admin.tailor_seller_form')}}" class="btn btn-primary">Add New</a>
          </div>
          <div class="x_content">
            <div class="row">
              <div class="col-sm-12">
