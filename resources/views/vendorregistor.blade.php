            ...
            <div class="container">
                <div class="row elite-register-inner">
                    <div class="signup-login-btn">
                        <a href="{{ url('register') }}" class="btn btn-outline-primary btn-lg btn-block vendor" style="width: 49%;">Customer</a>
                        <a href="{{ route('vendorSignupForm') }}" class="btn btn-block btn-primary btn-lg btn-block customer" style="width: 49%;">Vendor</a>
                    </div>
                    ...
                    @endif
                        ...
                        <div class="form-register">
                            ...
                            <p class="already-account">Already have an account? <a href="{{ route('vendorLoginForm') }}">Sign In</a></p>
